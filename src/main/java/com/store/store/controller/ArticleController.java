...
import com.store.store.domain.ArticleBuilder;
import com.store.store.domain.Brand;
import com.store.store.domain.Category;
import com.store.store.domain.Size;
